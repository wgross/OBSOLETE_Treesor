...
namespace Treesor.PowershellDriveProvider.Test
{
    ...
    public class TreesorDriveProviderItemCmdletTest
    {
        ...
        [Test]
        public void Powershell_get_item_root_returns_DriveInfo()
        {
            // ARRANGE
        ...
        [Test]
        public void Powershell_set_item_root_set_value()
        {
            // ARRANGE

            var rootContainer = new TreesorContainerNode
            {
                Name = ""
            };
        ...
        [Test]
        public void Powershell_clear_item_root_deletes_value()
        {
            // ARRANGE
        ...
        [Test]
        public void Powershell_test_path_root_returns_true()
        {
            // ARRANGE
